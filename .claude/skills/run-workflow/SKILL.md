...
- `03-inputs/vc-pitch.md` for Three Amigos
...
### Step 7: Clean up and report to user

For workflows that use the Teams system (e.g. `assess-vc-pitch-by-three-amigos`):
- Call `TeamDelete` to shut down all team members before reporting.
