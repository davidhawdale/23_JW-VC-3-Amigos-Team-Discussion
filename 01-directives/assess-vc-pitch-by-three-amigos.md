...
The VC pitch (`03-inputs/vc-pitch.md`) distils interview research into a one-page investment narrative for a personal AI assistant product. A pitch this condensed inevitably makes trade-offs: it emphasises some things and glosses over others. This workflow catches those gaps before investors do.
...
|-------|----------|-------|
| VC Pitch | `03-inputs/vc-pitch.md` | Must exist. Generate with `analyze-by-vc-pitch` workflow if missing. |
